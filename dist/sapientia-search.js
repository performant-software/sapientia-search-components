...
import U, { useRef as ut, useContext as Kt, createElement as sl, createContext as Qn, useState as xt, useLayoutEffect as ul, useEffect as Pt, useMemo as Yn, useReducer as cl, useCallback as ll, version as fl, Fragment as dl, forwardRef as Je } from "react";
...
function vl() {
  return Ao || (Ao = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var S = !1, m = !1, x = !1, j = !1, D = !1, w;
    w = Symbol.for("react.module.reference");
    function _(O) {
      return !!(typeof O == "string" || typeof O == "function" || O === n || O === a || D || O === i || O === u || O === l || j || O === d || S || m || x || typeof O == "object" && O !== null && (O.$$typeof === h || O.$$typeof === f || O.$$typeof === o || O.$$typeof === s || O.$$typeof === c || // This needs to include all possible module reference object
...
`), He = ie.stack.split(`
`), Ne = he.length - 1, ke = He.length - 1; Ne >= 1 && ke >= 0 && he[Ne] !== He[ke]; )
            ke--;
          for (; Ne >= 1 && ke >= 0; Ne--, ke--)
            if (he[Ne] !== He[ke]) {
              if (Ne !== 1 || ke !== 1)
                do
                  if (Ne--, ke--, ke < 0 || he[Ne] !== He[ke]) {
                    var Ve = `
` + he[Ne].replace(" at new ", " at ");
      ...
      var Ft = O ? O.displayName || O.name : "", jo = Ft ? A(Ft) : "";
    ...
    var je = Object.prototype.hasOwnProperty, de = {}, Ee = R.ReactDebugCurrentFrame;
    function qe(O) {
      if (O) {
    ...
    function mn(O, k, M, ie, ce, me) {
      {
        ...
        if (!ve) {
          ...
          He ? he += He : he += Ut();
          var Ne;
          O === null ? Ne = "null" : lt(O) ? Ne = "array" : O !== void 0 && O.$$typeof === t ? (Ne = "<" + (F(O.type) || "Unknown") + " />", he = " Did you accidentally export a JSX literal instead of a component?") : Ne = typeof O, y("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Ne, he);
        }
...
process.env.NODE_ENV === "production" ? $i.exports = pl() : $i.exports = vl();
var T = $i.exports;
(function() {
  (function(e) {
    (function(t) {
      ...
      x.redirect = function(w, _) {
        if (j.indexOf(_) === -1)
          throw new RangeError("Invalid status code");
        return new x(null, { status: _, headers: { location: w } });
        ...
        return new Promise(function(W, Z) {
          ...
          Y.onload = function() {
            var oe = {
              ...
              headers: m(Y.getAllResponseHeaders() || "")
            };
      ...
      return D.polyfill = !0, e.fetch || (e.fetch = D, e.Headers = u, e.Request = b, e.Response = x), t.Headers = u, t.Request = b, t.Response = x, t.fetch = D, Object.defineProperty(t, "__esModule", { value: !0 }), t;
    })({});
...
function _l(e) {
  var t, r, n = "X-Meilisearch-Client", i = "Meilisearch JavaScript (v".concat(Pl, ")"), a = "Content-Type", o = "Authorization", s = El((r = (t = e.requestConfig) === null || t === void 0 ? void 0 : t.headers) !== null && r !== void 0 ? r : {});
...
function Hl(e) {
  ...
  if ((n != null || i != null) && (n === "all" ? console.warn("instant-meilisearch is not compatible with the `all` value on the aroundRadius parameter") : n != null ? o = n : o = i), t && typeof t == "string") {
    var f = t.split(",").map(function(g) {
      return parseFloat(g);
    }), h = f[0], d = f[1], p = f[2], v = f[3];
    s = "_geoBoundingBox([".concat(h, ", ").concat(d, "], [").concat(p, ", ").concat(v, "])");
...
function Wl(e, t, r) {
  var n = r.trim(), i = Fo(e), a = Fo(t), o = ii(ii(ii([], i, !0), a, !0), [
    n
...
function Cu(e) {
  ...
  return {
    ...
    addPagination: function() {
      var b = Bl(y, l, u);
      if (h.finite) {
        var S = Vl(h, b), m = S.hitsPerPage, x = S.page;
        t.hitsPerPage = m, t.page = x;
      } else {
    ...
    addGeoSearchFilter: function() {
      var b = e.insideBoundingBox, S = e.aroundLatLng, m = e.aroundRadius, x = e.minimumAroundRadius, j = Hl({
        insideBoundingBox: b,
        aroundLatLng: S,
        aroundRadius: m,
        minimumAroundRadius: x
      });
...
function uf(e, t, r) {
  var n = e.processingTimeMs, i = e.query, a = e.indexUid, o = e.facetDistribution, s = o === void 0 ? {} : o, c = e.facetStats, u = c === void 0 ? {} : c, l = Object.keys(s), f = tf(e, e.pagination), h = f.hitsPerPage, d = f.page, p = f.nbPages, v = Zl(e, r), g = Jl(e), R = af(r.keepZeroFacets, l, t, s), y = {
    index: a,
    hitsPerPage: h,
    page: d,
    facets: R,
...
function Ha(e, t, r) {
  ...
  return {
    ...
    search: function(l) {
      return Mn(this, void 0, void 0, function() {
        var f, h, d, p, v, g, R, y, b, S, m, x;
        return Ln(this, function(j) {
          switch (j.label) {
            case 0:
              for (j.trys.push([0, 3, , 4]), f = [], h = [], d = [], p = 0, v = l; p < v.length; p++)
                g = v[p], R = ff(g, r), y = zl(R), f.push(y), b = hf(R), d.push(b), h.push(R.pagination);
              return [
                4,
                pf(s, d, c)
            ...
            case 2:
              return S = j.sent(), m = sf(S, c, u), [2, m];
            case 3:
              throw x = j.sent(), console.error(x), new Error(x);
            case 4:
              return [
                2
                /*return*/
...
function gf() {
  if (No)
    return Pe;
  No = 1;
  var e = 60103, t = 60106, r = 60107, n = 60108, i = 60114, a = 60109, o = 60110, s = 60112, c = 60113, u = 60120, l = 60115, f = 60116, h = 60121, d = 60122, p = 60117, v = 60129, g = 60131;
  if (typeof Symbol == "function" && Symbol.for) {
    var R = Symbol.for;
    e = R("react.element"), t = R("react.portal"), r = R("react.fragment"), n = R("react.strict_mode"), i = R("react.profiler"), a = R("react.provider"), o = R("react.context"), s = R("react.forward_ref"), c = R("react.suspense"), u = R("react.suspense_list"), l = R("react.memo"), f = R("react.lazy"), h = R("react.block"), d = R("react.server.block"), p = R("react.fundamental"), v = R("react.debug_trace_mode"), g = R("react.legacy_hidden");
  }
  function y(F) {
  ...
  var b = a, S = e, m = s, x = r, j = f, D = l, w = t, _ = i, W = n, Z = c;
  return Pe.ContextConsumer = o, Pe.ContextProvider = b, Pe.Element = S, Pe.ForwardRef = m, Pe.Fragment = x, Pe.Lazy = j, Pe.Memo = D, Pe.Portal = w, Pe.Profiler = _, Pe.StrictMode = W, Pe.Suspense = Z, Pe.isAsyncMode = function() {
    return !1;
    ...
    return typeof F == "string" || typeof F == "function" || F === r || F === i || F === v || F === n || F === c || F === u || F === g || typeof F == "object" && F !== null && (F.$$typeof === f || F.$$typeof === l || F.$$typeof === a || F.$$typeof === o || F.$$typeof === s || F.$$typeof === p || F.$$typeof === h || F[0] === d);
  }, Pe.typeOf = y, Pe;
}
var xe = {};
/** @license React v17.0.2
...
function yf() {
  return ko || (ko = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    if (typeof Symbol == "function" && Symbol.for) {
      var R = Symbol.for;
      e = R("react.element"), t = R("react.portal"), r = R("react.fragment"), n = R("react.strict_mode"), i = R("react.profiler"), a = R("react.provider"), o = R("react.context"), s = R("react.forward_ref"), c = R("react.suspense"), u = R("react.suspense_list"), l = R("react.memo"), f = R("react.lazy"), h = R("react.block"), d = R("react.server.block"), p = R("react.fundamental"), R("react.scope"), R("react.opaque.id"), v = R("react.debug_trace_mode"), R("react.offscreen"), g = R("react.legacy_hidden");
    }
    var y = !1;
    function b(H) {
      return !!(typeof H == "string" || typeof H == "function" || H === r || H === i || H === v || H === n || H === c || H === u || H === g || y || typeof H == "object" && H !== null && (H.$$typeof === f || H.$$typeof === l || H.$$typeof === a || H.$$typeof === o || H.$$typeof === s || H.$$typeof === p || H.$$typeof === h || H[0] === d));
    }
    function S(H) {
    ...
    var m = o, x = a, j = e, D = s, w = r, _ = f, W = l, Z = t, F = i, Y = n, re = c, oe = !1, J = !1;
    function z(H) {
    ...
    xe.ContextConsumer = m, xe.ContextProvider = x, xe.Element = j, xe.ForwardRef = D, xe.Fragment = w, xe.Lazy = _, xe.Memo = W, xe.Portal = Z, xe.Profiler = F, xe.StrictMode = Y, xe.Suspense = re, xe.isAsyncMode = z, xe.isConcurrentMode = ae, xe.isContextConsumer = C, xe.isContextProvider = L, xe.isElement = I, xe.isForwardRef = $, xe.isFragment = N, xe.isLazy = B, xe.isMemo = P, xe.isPortal = Q, xe.isProfiler = A, xe.isStrictMode = ee, xe.isSuspense = K, xe.isValidElementType = b, xe.typeOf = S;
  }()), xe;
}
process.env.NODE_ENV === "production" ? Ni.exports = gf() : Ni.exports = yf();
var Wa = Ni.exports;
function bf(e) {
  function t(I, $, N, B, P) {
    for (var Q = 0, A = 0, ee = 0, K = 0, H, E, fe = 0, pe = 0, ue, je = ue = H = 0, de = 0, Ee = 0, qe = 0, Le = 0, ct = N.length, lt = ct - 1, Ke, le = "", _e = "", Tt = "", ot = "", Ue; de < ct; ) {
      if (E = N.charCodeAt(de), de === lt && A + K + ee + Q !== 0 && (A !== 0 && (E = A === 47 ? 10 : 47), K = ee = Q = 0, ct++, lt++), A + K + ee + Q === 0) {
        if (de === lt && (0 < Ee && (le = le.replace(h, "")), 0 < le.trim().length)) {
          switch (E) {
            case 32:
            case 9:
            case 59:
        ...
        switch (E) {
          case 123:
                      ...
                      e: {
                        for (je = de + 1; je < lt; ++je)
                          switch (N.charCodeAt(je)) {
                            case 47:
                              if (E === 42 && N.charCodeAt(je - 1) === 42 && de + 2 !== je) {
                                de = je + 1;
                                break e;
                              }
                              break;
            ...
            switch (ue = N.substring(Le, de), H === 0 && (H = (le = le.replace(f, "").trim()).charCodeAt(0)), H) {
              case 64:
                switch (0 < Ee && (le = le.replace(h, "")), E = le.charCodeAt(1), E) {
                  case 100:
                  case 109:
                  case 115:
                  case 45:
                ...
                if (ue = t($, Ee, ue, E, P + 1), Le = ue.length, 0 < z && (Ee = r(oe, le, qe), Ue = s(3, ue, Ee, $, F, Z, Le, E, P, B), le = Ee.join(""), Ue !== void 0 && (Le = (ue = Ue.trim()).length) === 0 && (E = 0, ue = "")), 0 < Le)
                  switch (E) {
                    case 115:
                      le = le.replace(x, o);
                    case 100:
            ...
            Tt += ue, ue = qe = Ee = je = H = 0, le = "", E = N.charCodeAt(++de);
            break;
          case 125:
          case 59:
            if (le = (0 < Ee ? le.replace(h, "") : le).trim(), 1 < (Le = le.length))
              switch (je === 0 && (H = le.charCodeAt(0), H === 45 || 96 < H && 123 > H) && (Le = (le = le.replace(" ", ":")).length), 0 < z && (Ue = s(1, le, $, I, F, Z, _e.length, B, P, B)) !== void 0 && (Le = (le = Ue.trim()).length) === 0 && (le = "\0\0"), H = le.charCodeAt(0), E = le.charCodeAt(1), H) {
                case 0:
                  break;
                case 64:
                  if (E === 105 || E === 99) {
                ...
                default:
                  le.charCodeAt(Le - 1) !== 58 && (_e += i(le, H, E, le.charCodeAt(2)));
              }
            qe = Ee = je = H = 0, le = "", E = N.charCodeAt(++de);
        }
      }
      switch (E) {
        case 13:
        case 10:
          A === 47 ? A = 0 : 1 + H === 0 && B !== 107 && 0 < le.length && (Ee = 1, le += "\0"), 0 < z * C && s(0, le, $, I, F, Z, _e.length, B, P, B), Z = 1, F++;
          break;
        case 59:
        case 125:
          if (A + K + ee + Q === 0) {
          ...
          switch (Z++, Ke = N.charAt(de), E) {
            ...
            case 47:
              if (!(0 < K + Q + ee))
                switch (A) {
                  case 0:
                    switch (2 * E + 3 * N.charCodeAt(de + 1)) {
                      case 235:
                        A = 47;
                        break;
                      case 220:
                    ...
                    break;
                  case 42:
                    E === 47 && fe === 42 && Le + 2 !== de && (N.charCodeAt(Le + 2) === 33 && (_e += N.substring(Le, de + 1)), Ke = "", A = 0);
                }
          }
          A === 0 && (le += Ke);
      }
    ...
    if (Le = _e.length, 0 < Le) {
      if (Ee = $, 0 < z && (Ue = s(2, _e, Ee, I, F, Z, Le, B, P, B), Ue !== void 0 && (_e = Ue).length === 0))
        return ot + _e + Tt;
      if (_e = Ee.join(",") + "{" + _e + "}", re * Y !== 0) {
    ...
    switch (Q) {
      ...
      case 962:
        if (P = "-webkit-" + P + (P.charCodeAt(5) === 102 ? "-ms-" + P : "") + P, N + B === 211 && P.charCodeAt(13) === 105 && 0 < P.indexOf("transform", 10))
          return P.substring(0, P.indexOf(";", 27) + 1).replace(v, "$1-webkit-$2") + P;
    }
    return P;
  }
  function a(I, $) {
  ...
  function s(I, $, N, B, P, Q, A, ee, K, H) {
    for (var E = 0, fe = $, pe; E < z; ++E)
      switch (pe = J[E].call(l, I, fe, N, B, P, Q, A, ee, K, H)) {
        case void 0:
        case !1:
        case !0:
        case null:
  ...
  var f = /^\0+/g, h = /[\0\r\f]/g, d = /: */g, p = /zoo|gra/, v = /([,: ])(transform)/g, g = /,\r+?/g, R = /([\t\r\n ])*\f?&/g, y = /@(k\w+)\s*(\S*)\s*/, b = /::(place)/g, S = /:(read-only)/g, m = /[svh]\w+-[tblr]{2}/, x = /\(\s*(.*)\s*\)/g, j = /([\s\S]*?);/g, D = /-self|flex-/g, w = /[^]*?(:[rp][el]a[\w-]+)[^]*/, _ = /stretch|:\s*\w+\-(?:conte|avail)/, W = /([^-])(image-set\()/, Z = 1, F = 1, Y = 0, re = 1, oe = [], J = [], z = 0, ae = null, C = 0, L = "";
...
function Rf() {
  ...
  return ye.AsyncMode = c, ye.ConcurrentMode = u, ye.ContextConsumer = s, ye.ContextProvider = o, ye.Element = t, ye.ForwardRef = l, ye.Fragment = n, ye.Lazy = p, ye.Memo = d, ye.Portal = r, ye.Profiler = a, ye.StrictMode = i, ye.Suspense = f, ye.isAsyncMode = function(m) {
    return S(m) || b(m) === c;
  }, ye.isConcurrentMode = S, ye.isContextConsumer = function(m) {
    return b(m) === s;
    ...
    return typeof m == "string" || typeof m == "function" || m === n || m === u || m === a || m === i || m === f || m === h || typeof m == "object" && m !== null && (m.$$typeof === p || m.$$typeof === d || m.$$typeof === o || m.$$typeof === s || m.$$typeof === l || m.$$typeof === g || m.$$typeof === R || m.$$typeof === y || m.$$typeof === v);
  }, ye.typeOf = b, ye;
}
var be = {};
/** @license React v16.13.1
...
function Pf() {
  return Lo || (Lo = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function b(E) {
      ...
      E === n || E === u || E === a || E === i || E === f || E === h || typeof E == "object" && E !== null && (E.$$typeof === p || E.$$typeof === d || E.$$typeof === o || E.$$typeof === s || E.$$typeof === l || E.$$typeof === g || E.$$typeof === R || E.$$typeof === y || E.$$typeof === v);
    }
    function S(E) {
    ...
    var m = c, x = u, j = s, D = o, w = t, _ = l, W = n, Z = p, F = d, Y = r, re = a, oe = i, J = f, z = !1;
    function ae(E) {
      return z || (z = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), C(E) || S(E) === c;
    }
    function C(E) {
      return S(E) === u;
    }
...
Ba[Ua.Memo] = Fu;
function Ho(e) {
  return Ua.isMemo(e) ? Fu : Ba[e.$$typeof] || Ef;
}
...
`;
...
}(), Fn = /* @__PURE__ */ new Map(), Wn = /* @__PURE__ */ new Map(), Er = 1, Sn = function(e) {
  if (Fn.has(e))
    return Fn.get(e);
  for (; Wn.has(Er); )
    Er++;
  ...
  t >= Er && (Er = t + 1), Fn.set(e, t), Wn.set(t, e);
  ...
  return e.prototype.generateAndInjectStyles = function(t, r, n) {
    ...
    if (this.baseStyle && a.push(this.baseStyle.generateAndInjectStyles(t, r, n)), this.isStatic && !n.hash)
      if (this.staticRulesId && r.hasNameForId(i, this.staticRulesId))
        ...
        var o = ir(this.rules, t, r, n).join(""), s = Li(zt(this.baseHash, o) >>> 0);
      ...
      for (var u = this.rules.length, l = zt(this.baseHash, n.hash), f = "", h = 0; h < u; h++) {
        ...
        if (typeof d == "string")
          ...
          var p = ir(d, t, r, n), v = Array.isArray(p) ? p.join("") : p;
          l = zt(l, v + h), f += v;
        }
      }
      if (f) {
...
function rd(e) {
  var t, r, n, i, a = e === void 0 ? Lt : e, o = a.options, s = o === void 0 ? Lt : o, c = a.plugins, u = c === void 0 ? Hn : c, l = new bf(s), f = [], h = function(v) {
    function g(R) {
      if (R)
        try {
          v(R + "}");
    ...
    return function(R, y, b, S, m, x, j, D, w, _) {
      switch (R) {
        case 1:
    ...
    return g === 0 && td.indexOf(R[r.length]) !== -1 || R.match(i) ? v : "." + t;
  };
  function p(v, g, R, y) {
    y === void 0 && (y = "&");
    var b = v.replace(ed, ""), S = g && R ? R + " " + g + " { " + b + " }" : b;
    return t = y, r = g, n = new RegExp("\\" + r + "\\b", "g"), i = new RegExp("(\\" + r + "\\b){2,}"), l(R || !g ? "" : g, S);
  }
  return l.use([].concat(u, [function(v, g, R) {
    v === 2 && R.length && R[0].lastIndexOf(r) > 0 && (R[0] = R[0].replace(n, d));
  }, h, function(v) {
    if (v === -2) {
      var g = f;
      return f = [], g;
    }
  }])), p.hash = u.length ? u.reduce(function(v, g) {
    return g.name || lr(15), zt(v, g.name);
  }, 5381).toString() : "", p;
}
var Mu = U.createContext();
Mu.Consumer;
var Lu = U.createContext(), nd = (Lu.Consumer, new ku()), Hi = rd();
function id() {
  return Kt(Mu) || nd;
}
function ad() {
...
function ir(e, t, r, n) {
  ...
  if (Tr(e)) {
    if (typeof (u = e) != "function" || u.prototype && u.prototype.isReactComponent || !t)
      return e;
    var c = e(t);
    return process.env.NODE_ENV !== "production" && Wa.isElement(c) && console.warn(Mi(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), ir(c, t, r, n);
  }
  var u;
  return e instanceof od ? r ? (e.inject(r, n), e.getName(n)) : e : Di(e) ? function l(f, h) {
    var d, p, v = [];
    for (var g in f)
      f.hasOwnProperty(g) && !Qo(f[g]) && (Array.isArray(f[g]) && f[g].isCss || Tr(f[g]) ? v.push(zo(g) + ":", f[g], ";") : Di(f[g]) ? v.push.apply(v, l(f[g], g)) : v.push(zo(g) + ": " + (d = g, (p = f[g]) == null || typeof p == "boolean" || p === "" ? "" : typeof p != "number" || p === 0 || d in wf || d.startsWith("--") ? String(p).trim() : p + "px") + ";"));
...
function fd(e) {
  for (var t = arguments.length, r = new Array(t > 1 ? t - 1 : 0), n = 1; n < t; n++)
    r[n - 1] = arguments[n];
  return Tr(e) || Di(e) ? Yo(ir(Bo(Hn, [e].concat(r)))) : r.length === 0 && e.length === 1 && typeof e[0] == "string" ? e : Yo(ir(Bo(e, r)));
}
...
function Uu(e, t, r) {
  ...
  var p, v = new Jf(r, f, n ? e.componentStyle : void 0), g = v.isStatic && o.length === 0, R = function(y, b) {
    return function(S, m, x, j) {
      var D = S.attrs, w = S.componentStyle, _ = S.defaultProps, W = S.foldedComponentIds, Z = S.shouldForwardProp, F = S.styledComponentId, Y = S.target, re = function(B, P, Q) {
        B === void 0 && (B = Lt);
        var A = Rt({}, P, { theme: B }), ee = {};
        return Q.forEach(function(K) {
          var H, E, fe, pe = K;
          for (H in Tr(pe) && (pe = pe(A)), pe)
            A[H] = ee[H] = H === "className" ? (E = ee[H], fe = pe[H], E && fe ? E + " " + fe : E || fe) : pe[H];
        }), [A, ee];
      }(hd(m, Kt(Wu), _) || Lt, m, D), oe = re[0], J = re[1], z = function(B, P, Q, A) {
      ...
      }(w, j, oe, process.env.NODE_ENV !== "production" ? S.warnTooManyClasses : void 0), ae = x, C = J.$as || m.$as || J.as || m.as || Y, L = Rn(C), I = J !== m ? Rt({}, m, {}, J) : m, $ = {};
      for (var N in I)
        N[0] !== "$" && N !== "as" && (N === "forwardedAs" ? $.as = I[N] : (Z ? Z(N, Do, C) : !L || Do(N)) && ($[N] = I[N]));
      return m.style && J.style !== m.style && ($.style = Rt({}, m.style, {}, J.style)), $.className = Array.prototype.concat(W, F, z !== F ? z : null, m.className, J.className).filter(Boolean).join(" "), $.ref = ae, sl(C, $);
    }(p, y, b, g);
  };
  return R.displayName = l, (p = U.forwardRef(R)).attrs = h, p.componentStyle = v, p.displayName = l, p.shouldForwardProp = d, p.foldedComponentIds = n ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : Hn, p.styledComponentId = f, p.target = n ? e.target : e, p.withComponent = function(y) {
    var b = t.componentId, S = function(x, j) {
      if (x == null)
        return {};
      var D, w, _ = {}, W = Object.keys(x);
      for (w = 0; w < W.length; w++)
        D = W[w], j.indexOf(D) >= 0 || (_[D] = x[D]);
      return _;
    }(t, ["componentId"]), m = b && b + "-" + (Rn(y) ? y : oi(Mi(y)));
    return Uu(y, Rt({}, S, { attrs: h, componentId: m }), r);
    ...
    var S = {}, m = !1;
    return function(x) {
      if (!m && (S[x] = !0, Object.keys(S).length >= 200)) {
...
}, Ad = Vt, qi = Kn, ui = Ka, Go = Od, qu = Gn, ci = Rd, Xo = Ga, Vi = Xa, $d = Ed, De = Ad;
function Za(e, t) {
...
tt.prototype = {
  ...
  removeNumericRefinement: function(e, t, r) {
    return r !== void 0 ? this.isNumericRefined(e, t, r) ? this.setQueryParameters({
      numericRefinements: this._clearNumericRefinements(function(n, i) {
        return i === e && n.op === t && Za(n.val, ci(r));
      })
  ...
  isNumericRefined: function(t, r, n) {
    ...
    if (n === void 0 || !i)
      return i;
    var a = ci(n), o = Cd(this.numericRefinements[t][r], a) !== void 0;
    return i && o;
  },
  /**
...
}, Hd = zd, Wd = zu, Ud = Gn, Bd = Qu, Yu = Ja, qd = Yu.escapeFacetValue, Vd = Yu.unescapeFacetValue;
function zd(e) {
  return function(r, n) {
...
var Gd = Kn, Bn = Ka, Ku = zu, li = Nd, ht = Gn, wr = kd, Xd = Qu, Gu = Ja, Zo = Gu.escapeFacetValue, Xu = Gu.unescapeFacetValue, Zd = Hd;
function Jo(e) {
  var t = {};
  return e.forEach(function(r, n) {
    t[r] = n;
...
function Ht(e, t, r) {
  ...
  Object.keys(u).forEach(function(l) {
    ...
    if (h) {
      ...
      var v = e.disjunctiveFacets.indexOf(l) !== -1, g = e.facets.indexOf(l) !== -1, R;
      v && (R = s[l], i.disjunctiveFacets[R] = {
        name: l,
        data: f,
        exhaustive: n.exhaustiveFacetsCount
    ...
    d.length === 0 || d[0].split(h).length < 2 || t.slice(c).forEach(function(p) {
      var v = p && p.facets ? p.facets : {};
      Object.keys(v).forEach(function(g) {
        var R = v[g], y = wr(e.hierarchicalFacets, function(x) {
          return x.name === f.name;
        }), b = wr(i.hierarchicalFacets[y], function(x) {
          return x.attribute === g;
        });
        if (b !== -1) {
          var S = {};
          if (d.length > 0) {
            var m = d[0].split(h)[0];
            S[m] = i.hierarchicalFacets[y][b].data[m];
          }
  ...
  }), this.hierarchicalFacets = this.hierarchicalFacets.map(Zd(e)), this.facets = li(this.facets), this.disjunctiveFacets = li(this.disjunctiveFacets), this._state = e;
}
...
Xe.prototype.removeListener = function(e, t) {
  ...
  if (!this._events || !this._events[e])
    return this;
  if (r = this._events[e], i = r.length, n = -1, r === t || Et(r.listener) && r.listener === t)
...
Xe.prototype.listeners = function(e) {
  var t;
  return !this._events || !this._events[e] ? t = [] : Et(this._events[e]) ? t = [this._events[e]] : t = this._events[e].slice(), t;
};
...
var nt = {
    ...
    return n.push({
      ...
      if (o.length > 0 && o[0].split(s).length > 1) {
        ...
        c.forEach(function(u, l) {
          ...
          var d = (f.facetFilters || []).reduce(function(v, g) {
            if (Array.isArray(g)) {
            ...
            return typeof g == "string" && !h(g) && v.push(g), v;
          }, []), p = c[l - 1];
  ...
  _getFacetFilters: function(e, t, r) {
    ...
    return Object.keys(s).forEach(function(c) {
      var u = s[c] || [], l = u[0];
      if (l !== void 0) {
        var f = e.getHierarchicalFacetByName(c), h = e._getHierarchicalFacetSeparator(f), d = e._getHierarchicalRootPath(f), p, v;
        if (t === c) {
          if (l.indexOf(h) === -1 || !d && r === !0 || d && d.split(h).length === l.split(h).length)
            return;
          d ? (v = d.split(h).length - 1, l = d) : (v = l.split(h).length - 2, l = l.slice(0, l.lastIndexOf(h))), p = f.attributes[v];
        } else
          v = l.split(h).length - 1, p = f.attributes[v];
        p && n.push([p + ":" + l]);
      }
    }), n;
  },
...
}, fh = nt, nc = "3.13.0", to = Vu, zi = ec, dh = lh, ar = fh, hh = eo, ph = rc, vh = Xa, mh = Ga, gh = Kn, ic = nc, yh = Ja.escapeFacetValue;
function ne(e, t, r) {
...
function Zh(e) {
  var t = e.instantSearchInstance, r = e.helper, n = e.attribute, i = e.widgetType, a = function() {
    for (var s = arguments.length, c = new Array(s), u = 0; u < s; u++)
      c[u] = arguments[u];
    var l = c[1], f = c[2], h = f === void 0 ? "Filter Applied" : f, d = c[0].split(":"), p = Qh(d, 2), v = p[0], g = p[1], R = typeof n == "string" ? n : n(l);
    if (c.length === 1 && Gi(c[0]) === "object")
      t.sendEventToInsights(c[0]);
    else if (v === "click" && (c.length === 2 || c.length === 3))
...
function gc(e) {
  ...
  if (h.length === 0)
    return [];
  var d = h[0].__queryID, p = ip(h), v = p.map(function(R) {
...
function vi(e, t, r, n) {
  ...
  if (t === "hierarchical") {
    for (var c = e.getHierarchicalFacetByName(r), u = n.split(c.separator), l = function(p) {
      ...
      o = o && o.data && Cr(Object.keys(o.data).map(l(o.data)), function(v) {
        return v.name === u[p];
      });
...
function pp(e, t) {
  var r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1, n = [], i = t.facetsRefinements, a = i === void 0 ? {} : i, o = t.facetsExcludes, s = o === void 0 ? {} : o, c = t.disjunctiveFacetsRefinements, u = c === void 0 ? {} : c, l = t.hierarchicalFacetsRefinements, f = l === void 0 ? {} : l, h = t.numericRefinements, d = h === void 0 ? {} : h, p = t.tagRefinements, v = p === void 0 ? [] : p;
  return Object.keys(a).forEach(function(g) {
    ...
    Object.keys(R).forEach(function(y) {
      var b = y, S = R[b], m = Array.isArray(S) ? S : [S];
...
var Ap = function(t, r) {
  ...
  return r.reduce(function(i, a) {
    var o = Lp(i, a), s = Fp(o, a), c = Ip(s, a), u = Mp(c, a), l = Dp(u, a), f = kp(l, a), h = Np(f, a), d = Cp(h, a), p = Hp(d, a), v = $p(p, a);
    return Ap(v, a);
  });
};
function Pr(e, t, r) {
...
function Gt(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, n = xc(), i = Rc(), a = ev(), o = Ss(t), s = Ss(r), c = ut(!0), u = ut(null), l = Yn(function() {
    var v = e(function(g, R) {
      if (R) {
        c.current = !0;
        return;
      }
    ...
    if (l.getWidgetRenderState) {
      var v, g = a.getHelper(), R = a.getWidgetUiState({})[a.getIndexId()];
      g.state = ((v = l.getWidgetSearchParameters) === null || v === void 0 ? void 0 : v.call(l, g.state, {
        uiState: R
      })) || g.state;
      var y = Jp(a), b = y.results, S = y.scopedResults, m = l.getWidgetRenderState({
        helper: g,
        parent: a,
  ...
  return {
    ...
    addWidgets: function(d) {
      ...
      return a = a.concat(d), s && d.length && (jc(u, {
        ...
        if (v.getRenderState) {
          var g = v.getRenderState(s.renderState[p.getIndexId()] || {}, Pr(s, p, s._initialUiState));
          mi({
            renderState: g,
        ...
        v.init && v.init(Pr(s, p, s._initialUiState));
    ...
    init: function(d) {
      var p = this, v, g = d.instantSearchInstance, R = d.parent, y = d.uiState;
      if (u === null) {
        s = g, c = R, o = y[i] || {};
        var b = g.mainHelper, S = En(a, {
          uiState: o,
        ...
        var m = (v = g._initialResults) === null || v === void 0 ? void 0 : v[this.getIndexId()];
        if (m) {
          var x = new ft.SearchResults(new ft.SearchParameters(m.state), m.results);
          l.lastResults = x, u.lastResults = x;
        }
    ...
    render: function(d) {
      var p = this, v = d.instantSearchInstance;
      v.status === "error" && !v.mainHelper.hasPendingRequests() && f && u.setState(f);
      var g = this.getResults() ? a : a.filter(_t);
      g.forEach(function(R) {
        if (R.getRenderState) {
          var y = R.getRenderState(v.renderState[p.getIndexId()] || {}, ds(v, p));
          mi({
            renderState: y,
    ...
    dispose: function() {
      ...
      }), s = null, c = null, (p = u) === null || p === void 0 || p.removeAllListeners(), u = null, (v = l) === null || v === void 0 || v.detach(), l = null;
    },
    getWidgetUiState: function(d) {
      return a.filter(_t).reduce(function(p, v) {
        return v.getWidgetUiState(p);
...
`));
  var c = s || {}, u = c.value, l = u === void 0 ? "" : u, f = Uv({
    descendantName: "highlighted"
  }) + (o.highlighted ? " ".concat(o.highlighted) : ""), h = vc(wc(Zn(l)));
...
function lm() {
  ...
  var s = o || Be;
  return function(c) {
    var u = c.instantSearchInstance, l = u.middleware.filter(function(m) {
    ...
    if (Array.isArray(s.queue)) {
      var R = Cr(s.queue.slice().reverse(), function(m) {
        var x = Nn(m, 1), j = x[0];
        return j === "setUserToken";
      }) || [], y = Nn(R, 2);
      v = y[1];
    }
    s("getUserToken", null, function(m, x) {
      g = x;
    }), (r || !As(s)) && s("init", qt({
      appId: d,
      apiKey: p,
    ...
    return {
      ...
      subscribe: function() {
        if (s.shouldAddScript) {
          var x = "[insights middleware]: could not load search-insights.js. Please load it manually following https://alg.li/insights-init";
          try {
            ...
            s.shouldAddScript = !1, u.emit("error", new Error(x));
          }
        }
      },
      started: function() {
        ...
        j && x(j), g ? (x(g), s("setUserToken", g)) : v && (x(v), s("setUserToken", v)), s("onUserTokenChange", x, {
          immediate: !0
        });
        var D = s;
        As(s) && (D = function(_, W) {
...
var hm = String.prototype.replace, pm = /%20/g, gi = {
  RFC1738: "RFC1738",
  RFC3986: "RFC3986"
}, oo = {
  default: gi.RFC3986,
  ...
  RFC1738: gi.RFC1738,
  RFC3986: gi.RFC3986
}, vm = oo, yi = Object.prototype.hasOwnProperty, Qt = Array.isArray, pt = function() {
  ...
  maybeMap: xm,
  merge: gm
}, ia = kc, jr = oo, Em = Object.prototype.hasOwnProperty, $s = {
  brackets: function(t) {
    return t + "[]";
  },
  comma: "comma",
  ...
  var v = t;
  if (typeof s == "function" ? v = s(r, v) : v instanceof Date ? v = l(v) : n === "comma" && Yt(v) && (v = ia.maybeMap(v, function(W) {
  ...
  if (Am(v) || ia.isBuffer(v)) {
    if (o) {
      var g = d ? r : o(r, Ye.encoder, p, "key", f);
      if (n === "comma" && d) {
        for (var R = _m.call(String(v), ","), y = "", b = 0; b < R.length; ++b)
          y += (b === 0 ? "" : ",") + h(o(R[b], Ye.encoder, p, "value", f));
        return [h(g) + "=" + y];
      }
      return [h(g) + "=" + h(o(v, Ye.encoder, p, "value", f))];
    }
  ...
  var m;
  if (n === "comma" && Yt(v))
    m = [{ value: v.length > 0 ? v.join(",") || null : void 0 }];
  else if (Yt(s))
    m = s;
  else {
    var x = Object.keys(v);
  ...
  for (var j = 0; j < m.length; ++j) {
    var D = m[j], w = typeof D == "object" && typeof D.value < "u" ? D.value : v[D];
    if (!(a && w === null)) {
      var _ = Yt(v) ? typeof n == "function" ? n(r, D) : r : r + (u ? "." + D : "[" + D + "]");
      Dc(S, e(
        w,
        _,
        n,
...
}, sr = kc, aa = Object.prototype.hasOwnProperty, Im = Array.isArray, Qe = {
  allowDots: !1,
  allowPrototypes: !1,
  arrayLimit: 20,
  charset: "utf-8",
  ...
  for (c = 0; c < o.length; ++c)
    if (c !== s) {
      ...
      h === -1 ? (d = r.decoder(l, Qe.decoder, u, "key"), p = r.strictNullHandling ? null : "") : (d = r.decoder(l.slice(0, h), Qe.decoder, u, "key"), p = sr.maybeMap(
        Mc(l.slice(h + 1), r),
        function(v) {
          return r.decoder(v, Qe.decoder, u, "value");
        }
      )), p && r.interpretNumericEntities && u === "iso-8859-1" && (p = Nm(p)), l.indexOf("[]=") > -1 && (p = Im(p) ? [p] : p), aa.call(n, d) ? n[d] = sr.combine(n[d], p) : n[d] = p;
    }
  return n;
}, Lm = function(e, t, r, n) {
...
function Xm() {
  var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, t = e.createURL, r = t === void 0 ? function(d) {
    var p = d.qsModule, v = d.routeState, g = d.location, R = g.protocol, y = g.hostname, b = g.port, S = b === void 0 ? "" : b, m = g.pathname, x = g.hash, j = p.stringify(v), D = S === "" ? "" : ":".concat(S);
    return j ? "".concat(R, "//").concat(y).concat(D).concat(m, "?").concat(j).concat(x) : "".concat(R, "//").concat(y).concat(D).concat(m).concat(x);
  } : t, n = e.parseURL, i = n === void 0 ? function(d) {
    var p = d.qsModule, v = d.location;
    return p.parse(v.search.slice(1), {
      arrayLimit: 99
    });
...
var og = function() {
  ...
  return function(c) {
    ...
    function l(d) {
      ...
      }, u.mainIndex.getWidgetUiState({})), v = a.stateToRoute(p);
      return n.createURL(v);
    }
    u._createURL = l;
    ...
    return {
      ...
      onStateChange: function(p) {
        var v = p.uiState, g = a.stateToRoute(v);
...
var Og = /* @__PURE__ */ function(e) {
  ...
  function r(n) {
    var i;
    pg(this, r), i = t.call(this), Fe($e(i), "client", void 0), Fe($e(i), "indexName", void 0), Fe($e(i), "insightsClient", void 0), Fe($e(i), "onStateChange", null), Fe($e(i), "helper", void 0), Fe($e(i), "mainHelper", void 0), Fe($e(i), "mainIndex", void 0), Fe($e(i), "started", void 0), Fe($e(i), "templatesConfig", void 0), Fe($e(i), "renderState", {}), Fe($e(i), "_stalledSearchDelay", void 0), Fe($e(i), "_searchStalledTimer", void 0), Fe($e(i), "_initialUiState", void 0), Fe($e(i), "_initialResults", void 0), Fe($e(i), "_createURL", void 0), Fe($e(i), "_searchFunction", void 0), Fe($e(i), "_mainHelperSearch", void 0), Fe($e(i), "middleware", []), Fe($e(i), "sendEventToInsights", void 0), Fe($e(i), "status", "idle"), Fe($e(i), "error", void 0), Fe($e(i), "scheduleSearch", Or(function() {
      i.started && i.mainHelper.search();
    })), Fe($e(i), "scheduleRender", Or(function() {
    ...
    })), Fe($e(i), "onInternalStateChange", Or(function() {
...
function Pg() {
  ...
  function s(f, h) {
    var d = h(), p = n({ inst: { value: d, getSnapshot: h } }), v = p[0].inst, g = p[1];
    return a(function() {
      v.value = d, v.getSnapshot = h, c(v) && g({ inst: v });
    }, [f, d, h]), i(function() {
...
function xg() {
  return Bs || (Bs = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function r(b) {
      {
        for (var S = arguments.length, m = new Array(S > 1 ? S - 1 : 0), x = 1; x < S; x++)
          m[x - 1] = arguments[x];
        n("error", b, m);
      }
    }
    function n(b, S, m) {
      {
        var x = t.ReactDebugCurrentFrame, j = x.getStackAddendum();
        j !== "" && (S += "%s", m = m.concat([j]));
        var D = m.map(function(w) {
          return String(w);
        });
    ...
    function h(b, S, m) {
      ...
      if (!f) {
        var j = S();
        a(x, j) || (r("The result of getSnapshot should be cached to avoid an infinite loop"), f = !0);
      }
      var D = o({
        inst: {
          value: x,
      ...
      return c(function() {
        w.value = x, w.getSnapshot = S, d(w) && _({
          inst: w
        });
      }, [b, x, S]), s(function() {
        d(w) && _({
    ...
    var v = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", g = !v, R = g ? p : h, y = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : R;
...
process.env.NODE_ENV === "production" ? ua.exports = Pg() : ua.exports = xg();
var Eg = ua.exports, qs = ["react (".concat(fl, ")"), "react-instantsearch (".concat(Bi, ")"), "react-instantsearch-hooks (".concat(Bi, ")")], Vs = "react-instantsearch-server (".concat(Bi, ")");
function _g(e) {
  var t = Dv(), r = xc(), n = Mv(), i = n == null ? void 0 : n.initialResults, a = ut(e), o = ut(null);
  if (n && (o = n.ssrSearchRef), o.current === null) {
    ...
    s._schedule = function(p) {
      s._schedule.queue.push(p), clearTimeout(s._schedule.timer), s._schedule.timer = setTimeout(function() {
        s._schedule.queue.forEach(function(v) {
          v();
        }), s._schedule.queue = [];
      }, 0);
...
function jg(e) {
  if (process.env.NODE_ENV === "development") {
    ...
    process.env.NODE_ENV === "development" && Ec(r, `
  ...
  return fr(t, Ys()), function(n) {
    ...
    return {
      ...
      getWidgetRenderState: function(f) {
        var h = f.results, d = f.scopedResults, p = f.createURL, v = f.helper;
        function g() {
...
var ay = function(t) {
  ...
  return fr(t, ry()), function(n) {
    var i = n || {}, a = i.escapeHTML, o = a === void 0 ? !0 : a, s = i.transformItems, c = s === void 0 ? function(b) {
      return b;
    } : s, u = i.cache, l = u === void 0 ? ny() : u, f, h, d, p, v = function(S, m) {
      var x = S.page, j = x === void 0 ? 0 : x, D = Object.keys(m).map(Number);
    ...
    return {
      ...
      render: function(S) {
        var m = S.instantSearchInstance, x = this.getWidgetRenderState(S);
        t(st(st({}, x), {}, {
          instantSearchInstance: m
        }), !1), d("view:internal", x.currentPageHits);
      },
      getRenderState: function(S, m) {
        return st(st({}, S), {}, {
          infiniteHits: this.getWidgetRenderState(m)
        });
      },
      getWidgetRenderState: function(S) {
        var m = S.results, x = S.helper, j = S.parent, D = S.state, w = S.instantSearchInstance, _, W = [], Z = j.getPreviousState() || D, F = l.read({
          state: Tn(Z)
        }) || {};
        if (!m)
          f = R(x), h = y(x), d = ap({
            ...
            widgetType: this.$$type,
            instantSearchInstance: w
          }), _ = Z.page === void 0 || v(Z, F) === 0;
        else {
          var Y, re, oe, J = Z.page, z = J === void 0 ? 0 : J;
          o && m.hits.length > 0 && (m.hits = qh(m.hits));
          var ae = yp(m.hits, m.page, m.hitsPerPage), C = Op(ae, m.queryID), L = c(C, {
            results: m
          }), I = !1;
          ...
          var $ = !((Y = m.disjunctiveFacets) !== null && Y !== void 0 && Y.length) && !((re = m.facets) !== null && re !== void 0 && re.length) && !((oe = m.hierarchicalFacets) !== null && oe !== void 0 && oe.length);
          F[z] === void 0 && !m.__isArtificial && w.status === "idle" && !(I && $) && (F[z] = L, l.write({
            state: Tn(Z),
            hits: F
          })), W = L, _ = v(Z, F) === 0;
        }
        var N = iy(F), B = m ? m.nbPages <= g(Z, F) + 1 : !0;
        return {
          hits: N,
          currentPageHits: W,
          sendEvent: d,
      ...
      dispose: function(S) {
        var m = S.state;
        r();
        var x = m.setQueryParameter("page", void 0);
        return o ? x.setQueryParameters(Object.keys(or).reduce(function(j, D) {
          return st(st({}, j), {}, qc({}, D, void 0));
        }, {})) : x;
      },
      getWidgetUiState: function(S, m) {
        var x = m.searchParameters, j = x.page || 0;
        return j ? st(st({}, S), {}, {
      ...
      getWidgetSearchParameters: function(S, m) {
        var x = m.uiState, j = S;
        o && (j = S.setQueryParameters(or));
        var D = x.page ? x.page - 1 : 0;
...
var vy = function(t) {
  ...
  return fr(t, Si()), function(n) {
    ...
    var f = function(b) {
      ...
      var j = b.state, D = S.min, w = S.max, _ = j.getNumericRefinement(o, ">=") || [], W = er(_, 1), Z = W[0], F = j.getNumericRefinement(o, "<=") || [], Y = er(F, 1), re = Y[0], oe = m === void 0 || m === "", J = x === void 0 || x === "", z = tu({
        min: oe ? void 0 : parseFloat(m),
        max: J ? void 0 : parseFloat(x),
        precision: l
      }), ae = z.min, C = z.max, L;
    ...
    function g(y) {
      var b = y.getNumericRefinement(o, ">=") || [], S = er(b, 1), m = S[0], x = y.getNumericRefinement(o, "<=") || [], j = er(x, 1), D = j[0], w = Te(m) ? m : -1 / 0, _ = Te(D) ? D : 1 / 0;
      return [w, _];
    }
    function R(y, b) {
      return function() {
        var S = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [void 0, void 0], m = er(S, 2), x = m[0], j = m[1], D = d(y, b, x, j);
    ...
    return {
      ...
      getWidgetRenderState: function(b) {
        var S = b.results, m = b.helper, x = b.instantSearchInstance, j = S && S.disjunctiveFacets || [], D = Cr(j, function(F) {
          return F.name === o;
        }), w = D && D.stats || {
          min: void 0,
          max: void 0
        }, _ = v(w), W = g(m), Z;
        return S ? Z = R(m, _) : Z = R(m, {
          min: void 0,
          max: void 0
        }), {
          refine: Z,
      ...
      getWidgetUiState: function(b, S) {
        var m = S.searchParameters, x = m.getNumericRefinements(o), j = x[">="], D = j === void 0 ? [] : j, w = x["<="], _ = w === void 0 ? [] : w;
        return D.length === 0 && _.length === 0 ? b : Ge(Ge({}, b), {}, {
          range: Ge(Ge({}, b.range), {}, kn({}, o, "".concat(D, ":").concat(_)))
        });
      },
      getWidgetSearchParameters: function(b, S) {
        var m = S.uiState, x = b.addDisjunctiveFacet(o).setQueryParameters({
          numericRefinements: Ge(Ge({}, b.numericRefinements), {}, kn({}, o, {}))
        });
        Te(s) && (x = x.addNumericRefinement(o, ">=", s)), Te(c) && (x = x.addNumericRefinement(o, "<=", c));
        var j = m.range && m.range[o];
        if (!j || j.indexOf(":") === -1)
          return x;
        var D = j.split(":").map(parseFloat), w = er(D, 2), _ = w[0], W = w[1];
        return Te(_) && (!Te(s) || s < _) && (x = x.removeNumericRefinement(o, ">="), x = x.addNumericRefinement(o, ">=", _)), Te(W) && (!Te(c) || W < c) && (x = x.removeNumericRefinement(o, "<="), x = x.addNumericRefinement(o, "<=", W)), x;
      }
    };
  };
};
...
var An = jt({
  ...
  return fr(t, An()), function(n) {
    var i = n || {}, a = i.attribute, o = i.operator, s = o === void 0 ? "or" : o, c = i.limit, u = c === void 0 ? 10 : c, l = i.showMore, f = l === void 0 ? !1 : l, h = i.showMoreLimit, d = h === void 0 ? 20 : h, p = i.sortBy, v = p === void 0 ? iu : p, g = i.escapeFacetValues, R = g === void 0 ? !0 : g, y = i.transformItems, b = y === void 0 ? function(J) {
      return J;
    } : y;
    if (!a)
        ...
        return function(L) {
          ...
          if (L === "" && x)
            ...
            z.searchForFacetValues(
              ...
              var P = R ? Vh(B.facetHits) : B.facetHits, Q = b(P.map(function(A) {
                var ee = A.escapedValue, K = A.value, H = nu(A, by);
                return Ae(Ae({}, H), {}, {
                  value: ee,
                  label: K
                });
    ...
    return {
      ...
      getRenderState: function(z, ae) {
        return Ae(Ae({}, z), {}, {
          refinementList: Ae(Ae({}, z.refinementList), {}, xr({}, a, this.getWidgetRenderState(ae)))
        });
      },
      getWidgetRenderState: function(z) {
        ...
        if ((!w || !D || !re) && (w = Zh({
          ...
          j = Q > A ? B.length <= A : B.length < A, m = ae, x = N, z.results && (W = F(z, this));
        }
      ...
      getWidgetUiState: function(z, ae) {
        ...
        return L.length ? Ae(Ae({}, z), {}, {
          refinementList: Ae(Ae({}, z.refinementList), {}, xr({}, a, L))
        }) : z;
      },
...
As this is not supported, please make sure to only use this attribute with one of the two operators.`)), z;
        ...
        if (!I) {
          ...
          return Q.setQueryParameters(xr({}, A, Ae(Ae({}, Q[A]), {}, xr({}, a, []))));
        }
...
var su = jt({
  ...
  return function(i) {
    ...
    return {
      $$type: "ais.sortBy",
      init: function(l) {
        var f = l.instantSearchInstance, h = this.getWidgetRenderState(l), d = h.currentRefinement, p = Cr(o, function(v) {
          return v.value === d;
        });
...
function Yy(e) {
  ...
  return /* @__PURE__ */ U.createElement("span", fa({}, l, {
...
function zc(e) {
  ...
  return /* @__PURE__ */ U.createElement(Yy, da({
    classNames: {
...
function an(e) {
  var t = e.hit, r = e.attribute, n = e.highlightedTagName, i = e.nonHighlightedTagName, a = e.separator, o = Jy(e, Zy), s = nn(t._highlightResult, r) || [], c = Array.isArray(s) ? s : [s], u = c.map(function(l) {
    return Zn(ro(l.value || ""));
  });
  return /* @__PURE__ */ U.createElement(zc, ha({}, o, {
    parts: u,
    highlightedTagName: n,
...
function ib(e) {
  var t = e.canRefine, r = e.items, n = e.onRefine, i = e.query, a = e.searchBox, o = e.noResults, s = e.showMore, c = e.canToggleShowMore, u = e.onToggleShowMore, l = e.isShowingMore, f = e.className, h = e.classNames, d = h === void 0 ? {} : h, p = e.translations, v = rb(e, tb);
  return /* @__PURE__ */ U.createElement("div", pa({}, v, {
...
function Qc(e) {
  ...
  function S(x) {
    x.preventDefault(), x.stopPropagation(), o && o(x), r.current && r.current.blur();
  }
  function m(x) {
    x.preventDefault(), x.stopPropagation(), a(x), r.current && r.current.focus();
  }
  return /* @__PURE__ */ U.createElement("div", va({}, b, {
...
function We(e) {
  var t = e.searchable, r = e.searchablePlaceholder, n = e.attribute, i = e.operator, a = e.limit, o = e.showMore, s = e.showMoreLimit, c = e.sortBy, u = e.escapeFacetValues, l = e.transformItems, f = e.translations, h = Pb(e, pb), d = xy({
    attribute: n,
    operator: i,
    limit: a,
    showMore: o,
  ...
  }), p = d.canRefine, v = d.canToggleShowMore, g = d.isFromSearch, R = d.isShowingMore, y = d.items, b = d.refine, S = d.searchForItems, m = d.toggleShowMore, x = xt(""), j = bb(x, 2), D = j[0], w = j[1], _ = ut(null);
  function W(z) {
    w(z), S(z);
  }
  function Z(z) {
  ...
  return /* @__PURE__ */ U.createElement(ib, ma({}, h, J, {
    showMore: o
  }));
}
function en(e) {
...
var Eb = ["queryHook", "searchAsYouType", "translations"];
function ga() {
...
function Mb(e) {
  var t = e.queryHook, r = e.searchAsYouType, n = r === void 0 ? !0 : r, i = e.translations, a = kb(e, Eb), o = Fy({
    queryHook: t
  }, {
    $$widgetType: "ais.searchBox"
  }), s = o.query, c = o.refine, u = o.isSearchStalled, l = xt(s), f = $b(l, 2), h = f[0], d = f[1], p = ut(null);
  function v(S) {
    d(S), n && c(S);
  }
  function g() {
  ...
  return /* @__PURE__ */ U.createElement(Qc, ga({}, a, b));
}
...
function Ub(e) {
  ...
  return /* @__PURE__ */ U.createElement("div", ya({}, s, {
...
function zb(e) {
  ...
  return /* @__PURE__ */ U.createElement(Ub, ba({}, n, c));
}
const Qb = (e) => Array.isArray(e) ? /* @__PURE__ */ T.jsx("span", { children: e.join(", ") }) : /* @__PURE__ */ T.jsx("span", { children: e }), Yb = ({ hit: e, onHitClick: t, children: r }) => /* @__PURE__ */ T.jsx(
  "a",
  {
    className: "hitLink",
    onClick: t ? () => t(e) : () => null,
...
), Kb = ({ hit: e, hitConfig: t, onHitClick: r, hitWrapperComponent: n, getHitWrapperProps: i }) => {
  const a = n || Yb, o = Yn(() => i ? i(e) : { hit: e, onHitClick: r }, [i, e, r]);
  return /* @__PURE__ */ T.jsx(a, { ...o, className: "hitLink", children: /* @__PURE__ */ T.jsxs("li", { className: "hit", children: [
    /* @__PURE__ */ T.jsxs("div", { className: "left", children: [
      ...
      t.leftColumnItems.map((s) => {
        if (s.renderDisplay || e[s.attribute])
          return /* @__PURE__ */ T.jsxs(
            "p",
            {
              className: "hitData",
              children: [
                /* @__PURE__ */ T.jsx("span", { title: s.caption, children: s.icon }),
                /* @__PURE__ */ T.jsx("strong", { children: s.renderDisplay ? s.renderDisplay(e) : Qb(e[s.attribute]) })
              ]
            },
            s.attribute
          );
...
function Xb() {
  ...
  return we.AsyncMode = c, we.ConcurrentMode = u, we.ContextConsumer = s, we.ContextProvider = o, we.Element = t, we.ForwardRef = l, we.Fragment = n, we.Lazy = p, we.Memo = d, we.Portal = r, we.Profiler = a, we.StrictMode = i, we.Suspense = f, we.isAsyncMode = function(m) {
    return S(m) || b(m) === c;
  }, we.isConcurrentMode = S, we.isContextConsumer = function(m) {
    return b(m) === s;
...
var xi, gu;
function Kc() {
  return gu || (gu = 1, xi = Function.call.bind(Object.prototype.hasOwnProperty)), xi;
}
var Ei, yu;
function e0() {
  if (yu)
...
function t0() {
  if (bu)
    return _i;
  bu = 1;
  var e = Yc(), t = Jb(), r = so(), n = Kc(), i = e0(), a = function() {
  };
  ...
  return _i = function(s, c) {
    ...
    function g(C) {
      ...
      function $(B, P, Q, A, ee, K, H) {
        ...
        return P[Q] == null ? B ? P[Q] === null ? new v("The " + ee + " `" + K + "` is marked as required " + ("in `" + A + "`, but its value is `null`.")) : new v("The " + ee + " `" + K + "` is marked as required in " + ("`" + A + "`, but its value is `undefined`.")) : null : C(P, Q, A, ee, K);
      }
      var N = $.bind(null, !1);
    ...
    function b(C) {
      function L(I, $, N, B, P) {
        if (typeof C != "function")
          return new v("Property `" + P + "` of component `" + N + "` has invalid PropType notation inside arrayOf.");
        var Q = I[$];
        if (!Array.isArray(Q)) {
          var A = oe(Q);
          return new v("Invalid " + B + " `" + P + "` of type " + ("`" + A + "` supplied to `" + N + "`, expected an array."));
        }
    ...
    function S() {
      function C(L, I, $, N, B) {
        ...
        if (!s(P)) {
          var Q = oe(P);
          return new v("Invalid " + N + " `" + B + "` of type " + ("`" + Q + "` supplied to `" + $ + "`, expected a single ReactElement."));
        }
        return null;
      }
      return g(C);
    ...
    function m() {
      function C(L, I, $, N, B) {
        ...
        if (!e.isValidElementType(P)) {
          var Q = oe(P);
          return new v("Invalid " + N + " `" + B + "` of type " + ("`" + Q + "` supplied to `" + $ + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return g(C);
    ...
    function x(C) {
      function L(I, $, N, B, P) {
        if (!(I[$] instanceof C)) {
          ...
          return new v("Invalid " + B + " `" + P + "` of type " + ("`" + A + "` supplied to `" + N + "`, expected ") + ("instance of `" + Q + "`."));
        }
        return null;
      }
      return g(L);
    ...
    function j(C) {
      ...
      function L(I, $, N, B, P) {
        for (var Q = I[$], A = 0; A < C.length; A++)
          if (p(Q, C[A]))
            return null;
        var ee = JSON.stringify(C, function(H, E) {
          var fe = J(E);
          return fe === "symbol" ? String(E) : E;
        });
        return new v("Invalid " + B + " `" + P + "` of value `" + String(Q) + "` " + ("supplied to `" + N + "`, expected one of " + ee + "."));
      }
      return g(L);
    }
    function D(C) {
      function L(I, $, N, B, P) {
        if (typeof C != "function")
          return new v("Property `" + P + "` of component `" + N + "` has invalid PropType notation inside objectOf.");
        var Q = I[$], A = oe(Q);
        if (A !== "object")
          return new v("Invalid " + B + " `" + P + "` of type " + ("`" + A + "` supplied to `" + N + "`, expected an object."));
        for (var ee in Q)
          if (n(Q, ee)) {
            var K = C(Q, ee, N, B, P + "." + ee, r);
            if (K instanceof Error)
    ...
    function w(C) {
      ...
      function $(N, B, P, Q, A) {
        for (var ee = [], K = 0; K < C.length; K++) {
          var H = C[K], E = H(N, B, P, Q, A, r);
          if (E == null)
            return null;
          E.data && n(E.data, "expectedType") && ee.push(E.data.expectedType);
        }
        var fe = ee.length > 0 ? ", expected one of type [" + ee.join(", ") + "]" : "";
        return new v("Invalid " + Q + " `" + A + "` supplied to " + ("`" + P + "`" + fe + "."));
      }
      return g($);
    }
    function _() {
      function C(L, I, $, N, B) {
        return Y(L[I]) ? null : new v("Invalid " + N + " `" + B + "` supplied to " + ("`" + $ + "`, expected a ReactNode."));
      }
      return g(C);
    }
    function W(C, L, I, $, N) {
    ...
    function Z(C) {
      function L(I, $, N, B, P) {
        var Q = I[$], A = oe(Q);
        if (A !== "object")
          return new v("Invalid " + B + " `" + P + "` of type `" + A + "` " + ("supplied to `" + N + "`, expected `object`."));
        for (var ee in C) {
          var K = C[ee];
          if (typeof K != "function")
...
if (process.env.NODE_ENV !== "production") {
  var n0 = Yc(), i0 = !0;
  wa.exports = t0()(n0.isElement, i0);
} else
  wa.exports = r0()();
var a0 = wa.exports;
const X = /* @__PURE__ */ cr(a0);
var o0 = ["color", "size", "title"];
function Sa() {
...
var uo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = s0(e, o0);
...
var co = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = f0(e, l0);
...
var lo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = p0(e, h0);
...
var fo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = y0(e, g0);
...
var ho = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = O0(e, S0);
...
var po = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = x0(e, P0);
...
var vo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = j0(e, _0);
...
var mo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = C0(e, $0);
...
var go = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = k0(e, N0);
...
var yo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = H0(e, L0);
...
var bo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = q0(e, B0);
...
var wo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = Y0(e, Q0);
...
var So = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = Z0(e, X0);
...
var Oo = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = t1(e, e1);
...
var Ro = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = a1(e, i1);
...
var Po = /* @__PURE__ */ Je(function(e, t) {
  var r = e.color, n = e.size, i = e.title, a = c1(e, u1);
  return /* @__PURE__ */ U.createElement("svg", ka({
    ref: t,
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 16 16",
    width: n,
...
`, Ie = ({ header: e, children: t }) => /* @__PURE__ */ T.jsxs(d1, { children: [
...
`;
var Ce = /* @__PURE__ */ ((e) => (e.Number = "number", e.String = "string", e))(Ce || {});
const p1 = [
  {
    name: "number_order",
    type: Ce.Number,
...
], v1 = (e) => e.refinements[0].type === "numeric", m1 = (e) => {
  const {
    items: t,
    refine: r
  } = zg(e), { locale: n } = e, i = (s) => {
    var l, f, h;
    const c = (l = p1.find((d) => d.name === s.attribute)) == null ? void 0 : l.label[n];
    let u;
    if (v1(s)) {
  ...
  hitConfig: i,
  onHitClick: a,
  hitWrapperComponent: o,
  getHitWrapperProps: s
}) => {
  const [c, u] = xt(!1), [l, f] = xt(!0), h = ut(null), d = () => {
    h.current && l && u(!c);
  };
  return Pt(() => {
    const p = (g) => f(g.matches), v = window.matchMedia("(max-width: 800px)");
    return v.addEventListener("change", p), f(v.matches), () => v.removeEventListener("change", p);
  }, []), Pt(() => {
    h.current && u(!l);
  }, [l]), Pt(() => {
    h.current && (c ? h.current.style.transform = "translateX(0)" : h.current.style.transform = "translateX(-120vw)");
  }, [c]), /* @__PURE__ */ T.jsx(h1, { children: /* @__PURE__ */ T.jsx("div", { className: "search", children: /* @__PURE__ */ T.jsxs(
    Cg,
    {
      indexName: e,
      searchClient: n,
      children: [
        ...
        /* @__PURE__ */ T.jsxs("div", { className: "leftPanel", children: [
          /* @__PURE__ */ T.jsxs(Ie, { header: G.search[t], children: [
            /* @__PURE__ */ T.jsx(
              "button",
              {
                className: "filterButton",
                onClick: () => d(),
                children: /* @__PURE__ */ T.jsx(M0, {})
              }
            ),
            /* @__PURE__ */ T.jsx(
              Mb,
          ...
          /* @__PURE__ */ T.jsx("div", { className: "filters", ref: h, children: i.sortFields ? /* @__PURE__ */ T.jsx(Ie, { header: G.sort[t], children: /* @__PURE__ */ T.jsx(
            zb,
            {
              items: i.sortFields
            }
...
}, g1 = (e) => e.year && e.month && e.day ? /* @__PURE__ */ T.jsx("span", { children: new Date(e.year, e.month - 1, e.day).toISOString().slice(0, 10) }) : /* @__PURE__ */ T.jsx("span", { children: /* @__PURE__ */ T.jsx("em", { children: "?" }) }), Ti = (e, t, r) => {
  const n = t.split(".");
  let i = e;
  for (; n.length > 0; )
    if (i[n[0]])
...
) : /* @__PURE__ */ T.jsx("span", { children: /* @__PURE__ */ T.jsx("em", { children: G.emptyField[r] }) }), y1 = Ha(
...
), b1 = ({ locale: e, onHitClick: t, hitWrapperComponent: r, getHitWrapperProps: n }) => {
  const i = Yn(() => ({
    leftColumnItems: [
      {
        attribute: "archive.name",
        icon: /* @__PURE__ */ T.jsx(Xc, {}),
        caption: G.archive[e],
      ...
      {
        attribute: "works",
        icon: /* @__PURE__ */ T.jsx(w0, {}),
        caption: G.works[e],
        renderDisplay: (a) => a.works.map((o) => o.title).join(", ")
      }
    ],
    rightPanel: {
      attribute: "text",
    ...
    renderHeadlineAttribute: (a) => a.catalog_number ? /* @__PURE__ */ T.jsxs("span", { children: [
      "#",
      /* @__PURE__ */ T.jsx(
        an,
        {
  ...
  return /* @__PURE__ */ T.jsx(Qa, { children: /* @__PURE__ */ T.jsxs(
    xo,
    {
      searchClient: y1,
      locale: e,
      ...
      children: [
        /* @__PURE__ */ T.jsx(Ie, { header: G.works[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "works.title"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.origDate[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "OrigDate"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.origPlace[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "origPlace"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.sections[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "sections.shelfmark_sections_id.name"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.provenance[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "provenance"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.archive[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "archive"
          }
        ...
        /* @__PURE__ */ T.jsx(Ie, { header: G.shelfmarks[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "shelfmark"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.formerShelfmarks[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
...
), S1 = ({ locale: e, onHitClick: t, hitWrapperComponent: r, getHitWrapperProps: n }) => {
  const i = Yn(() => ({
    leftColumnItems: [
      {
        attribute: "generic_title",
        icon: /* @__PURE__ */ T.jsx(s1, {}),
      ...
      },
      {
        ...
        icon: /* @__PURE__ */ T.jsx(n1, {}),
        caption: G.publicationLocation[e],
        renderDisplay: (a) => Ti(a, "publication_location.name", e)
      },
      {
        attribute: "parent_edition.title",
        icon: /* @__PURE__ */ T.jsx(c0, {}),
        caption: G.parentEdition[e],
        renderDisplay: (a) => Ti(a, "parent_edition.title", e)
      },
      {
        attribute: "status",
        icon: /* @__PURE__ */ T.jsx(m0, {}),
        caption: G.status[e],
        renderDisplay: (a) => Dt(a, "status", e)
      },
      {
        attribute: "line",
        icon: /* @__PURE__ */ T.jsx(I0, {}),
        caption: G.line[e],
        renderDisplay: (a) => Dt(a, "line", e)
      },
      {
        attribute: "format",
        icon: /* @__PURE__ */ T.jsx(U0, {}),
        caption: G.format[e],
        renderDisplay: (a) => Dt(a, "format", e)
      },
      {
        attribute: "author_id.full_name",
        icon: /* @__PURE__ */ T.jsx(Jc, {}),
        caption: G.author[e],
        renderDisplay: (a) => Ti(a, "author_id.full_name", e)
      },
      {
        attribute: "archives",
        icon: /* @__PURE__ */ T.jsx(Gc, {}),
        caption: G.archive[e],
  ...
  return /* @__PURE__ */ T.jsx(Qa, { children: /* @__PURE__ */ T.jsxs(
    xo,
    {
      ...
      getHitWrapperProps: n,
      children: [
        /* @__PURE__ */ T.jsx(Ie, { header: G.status[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "status",
            transformItems: (a) => Oi(a, e)
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.author[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "author_id.full_name"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.format[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "format",
            transformItems: (a) => Oi(a, e)
        ...
        /* @__PURE__ */ T.jsx(Ie, { header: G.type[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "type",
            transformItems: (a) => Oi(a, e)
        ...
        /* @__PURE__ */ T.jsx(Ie, { header: G.publicationDate[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "publication_date"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.publicationLocation[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "publication_location.name"
          }
...
var A1 = tl.exports;
const on = /* @__PURE__ */ cr(A1);
var Ma = {}, Eo = [], $1 = function(t) {
  Eo.push(t);
};
function C1(e, t) {
  if (process.env.NODE_ENV !== "production" && !e && console !== void 0) {
    var r = Eo.reduce(function(n, i) {
      return i(n ?? "", "warning");
    }, t);
...
var Ou = process.env.NODE_ENV !== "test" && D1() ? te.useLayoutEffect : te.useEffect, M1 = function(t, r) {
  var n = te.useRef(!0);
  Ou(function() {
    return t(n.current);
  }, r), Ou(function() {
...
function L1(e, t) {
  ...
  }), c = it(s, 2), u = c[0], l = c[1], f = i !== void 0 ? i : u, h = o ? o(f) : f, d = Su(a), p = Pu([f]), v = it(p, 2), g = v[0], R = v[1];
  Ru(function() {
    var b = g[0];
    u !== b && d(u, b);
  }, [g]), Ru(function() {
...
var W1 = ["prefixCls", "value", "valueIndex", "onStartMove", "style", "render", "dragging", "onOffsetChange"], il = /* @__PURE__ */ te.forwardRef(function(e, t) {
  ...
  }, W = _o(g, a, p, v), Z = /* @__PURE__ */ te.createElement("div", zn({
    ref: t,
...
var U1 = ["prefixCls", "style", "onStartMove", "onOffsetChange", "values", "handleRender", "draggingIndex"], al = /* @__PURE__ */ te.forwardRef(function(e, t) {
  var r = e.prefixCls, n = e.style, i = e.onStartMove, a = e.onOffsetChange, o = e.values, s = e.handleRender, c = e.draggingIndex, u = nl(e, U1), l = te.useRef({});
...
function B1(e, t, r, n, i, a, o, s, c) {
  var u = te.useState(null), l = it(u, 2), f = l[0], h = l[1], d = te.useState(-1), p = it(d, 2), v = p[0], g = p[1], R = te.useState(r), y = it(R, 2), b = y[0], S = y[1], m = te.useState(r), x = it(m, 2), j = x[0], D = x[1], w = te.useRef(null), _ = te.useRef(null);
  te.useEffect(function() {
    v === -1 && S(r);
  }, [r, v]), te.useEffect(function() {
    return function() {
  ...
  var Y = function(J, z) {
    ...
    var ae = r[z];
    g(z), h(ae), D(r);
    var C = Eu(J), L = C.pageX, I = C.pageY, $ = function(P) {
      P.preventDefault();
      var Q = Eu(P), A = Q.pageX, ee = Q.pageY, K = A - L, H = ee - I, E = e.current.getBoundingClientRect(), fe = E.width, pe = E.height, ue;
      switch (t) {
        case "btt":
          ue = -H / pe;
          break;
...
function q1(e) {
  var t, r = e.prefixCls, n = e.style, i = e.start, a = e.end, o = e.index, s = e.onStartMove, c = te.useContext(Xt), u = c.direction, l = c.min, f = c.max, h = c.disabled, d = c.range, p = "".concat(r, "-track"), v = La(i, l, f), g = La(a, l, f), R = function(S) {
    !h && s && s(S, -1);
  }, y = {};
  switch (u) {
    case "rtl":
      y.right = "".concat(v * 100, "%"), y.width = "".concat(g * 100 - v * 100, "%");
      break;
    case "btt":
      y.bottom = "".concat(v * 100, "%"), y.height = "".concat(g * 100 - v * 100, "%");
      break;
    case "ttb":
      y.top = "".concat(v * 100, "%"), y.height = "".concat(g * 100 - v * 100, "%");
      break;
    default:
      y.left = "".concat(v * 100, "%"), y.width = "".concat(g * 100 - v * 100, "%");
  }
...
function G1(e, t, r, n, i, a) {
  var o = te.useCallback(function(d) {
    ...
    if (r !== null) {
      var p = e + Math.round((o(d) - e) / r) * r, v = function(b) {
        return (String(b).split(".")[1] || "").length;
      }, g = Math.max(v(r), v(t), v(e)), R = Number(p.toFixed(g));
      return e <= R && R <= t ? R : null;
    }
    return null;
  }, [r, e, t, o]), c = te.useCallback(function(d) {
    var p = o(d), v = n.map(function(y) {
      return y.value;
    });
    r !== null && v.push(s(d)), v.push(e, t);
    var g = v[0], R = t - e;
    return v.forEach(function(y) {
      var b = Math.abs(p - y);
      b <= R && (g = y, R = b);
    }), g;
  }, [e, t, n, r, o, s]), u = function d(p, v, g) {
    var R = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "unit";
    if (typeof v == "number") {
      var y, b = p[g], S = b + v, m = [];
      n.forEach(function(_) {
        m.push(_.value);
      }), m.push(e, t), m.push(s(b));
      var x = v > 0 ? 1 : -1;
      R === "unit" ? m.push(s(b + x * r)) : m.push(s(S)), m = m.filter(function(_) {
        return _ !== null;
      }).filter(function(_) {
        return v < 0 ? _ <= b : _ >= b;
      }), R === "unit" && (m = m.filter(function(_) {
        return _ !== b;
      }));
      var j = R === "unit" ? b : S;
      y = m[0];
      var D = Math.abs(y - j);
      if (m.forEach(function(_) {
        var W = Math.abs(_ - j);
        W < D && (y = _, D = W);
      }), y === void 0)
        return v < 0 ? e : t;
    ...
    var R = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "unit", y = p[g], b = u(p, v, g, R);
    return {
      value: b,
      changed: b !== y
    };
    ...
    var R = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "unit", y = p.map(c), b = y[g], S = u(y, v, g, R);
    if (y[g] = S, i === !1) {
      var m = a || 0;
      g > 0 && y[g - 1] !== b && (y[g] = Math.max(y[g], y[g - 1] + m)), g < y.length - 1 && y[g + 1] !== b && (y[g] = Math.min(y[g], y[g + 1] - m));
    } else if (typeof a == "number" || a === null) {
      for (var x = g + 1; x < y.length; x += 1)
        for (var j = !0; f(y[x] - y[x - 1]) && j; ) {
          var D = l(y, 1, x);
          y[x] = D.value, j = D.changed;
        }
      for (var w = g; w > 0; w -= 1)
...
var ol = /* @__PURE__ */ te.forwardRef(function(e, t) {
  ...
  }, [P]), lt = G1(de, Ee, qe, ct, Z, Le), Ke = it(lt, 2), le = Ke[0], _e = Ke[1], Tt = L1(m, {
    value: S
  ...
  var wt = function(k) {
    ...
    D && !k1(M, At.current, !0) && D(wt(M)), un(M);
  }, cn = function(k) {
    if (!c) {
      var M = 0, ie = Ee - de;
      ...
      var ce = Mt(rt);
      ce[M] = k, x && !rt.length && j === void 0 && ce.push(k), w == null || w(wt(ce)), dr(ce), _ == null || _(wt(ce));
    }
  }, ei = function(k) {
    k.preventDefault();
    var M = ue.current.getBoundingClientRect(), ie = M.width, ce = M.height, me = M.left, ve = M.top, he = M.bottom, He = M.right, Ne = k.clientX, ke = k.clientY, Ve;
    switch (je) {
      case "btt":
        Ve = (he - ke) / ce;
        break;
    ...
    var Ft = de + Ve * (Ee - de);
    cn(le(Ft));
  }, ti = te.useState(null), ln = it(ti, 2), hr = ln[0], Zt = ln[1], fn = function(k, M) {
    if (!c) {
      var ie = _e(rt, k, M);
  ...
  }, vr = B1(ue, je, rt, de, Ee, le, dr, pr, _e), Ut = it(vr, 4), dn = Ut[0], hn = Ut[1], mr = Ut[2], pn = Ut[3], gr = function(k, M) {
  ...
  var Ct = te.useMemo(function() {
    ...
    return x ? [Ct[0], Ct[Ct.length - 1]] : [de, Ct[0]];
  }, [Ct, x, de]), gn = it(mn, 2), yn = gn[0], bn = gn[1];
  ...
  }, [de, Ee, je, c, l, qe, ae, yn, bn, x, K, H, E, fe]);
...
const X1 = {
  ...
  return /* @__PURE__ */ T.jsxs(T.Fragment, { children: [
    /* @__PURE__ */ T.jsxs("div", { style: X1.sliderValues, children: [
...
), J1 = ({ locale: e, onHitClick: t, hitWrapperComponent: r, getHitWrapperProps: n }) => {
  const i = {
    leftColumnItems: [
      {
        attribute: "date",
        icon: /* @__PURE__ */ T.jsx(A0, {}),
        caption: G.date[e],
        renderDisplay: (a) => g1(a)
      },
      {
        attribute: "town",
        icon: /* @__PURE__ */ T.jsx(Xc, {}),
        caption: G.city[e],
        renderDisplay: (a) => Dt(a, "town.name", e)
      },
      {
        attribute: "place_given",
        icon: /* @__PURE__ */ T.jsx(z0, {}),
        caption: G.place_given[e],
        renderDisplay: (a) => Dt(a, "date_of_place.name", e)
      },
      {
        attribute: "titulature",
        icon: /* @__PURE__ */ T.jsx(Gc, {}),
        caption: G.titulature[e],
        renderDisplay: (a) => Dt(a, "titulature.full_name", e)
      },
      {
        attribute: "commandement",
        icon: /* @__PURE__ */ T.jsx(Jc, {}),
        caption: G.commandement[e],
        renderDisplay: (a) => Dt(a, "commandement.full_name", e)
      }
    ],
    rightPanel: {
      attribute: "texte",
    ...
    renderHeadlineAttribute: (a) => /* @__PURE__ */ T.jsxs("span", { children: [
      "#",
      /* @__PURE__ */ T.jsx(
        an,
        {
  ...
  return /* @__PURE__ */ T.jsx(Qa, { children: /* @__PURE__ */ T.jsxs(
    xo,
    {
      ...
      getHitWrapperProps: n,
      children: [
        /* @__PURE__ */ T.jsx(Ie, { header: G.number_of_order[e], children: /* @__PURE__ */ T.jsx(
          Cn,
          {
            attribute: "number_order"
          }
        ) }),
        /* @__PURE__ */ T.jsxs(Ie, { header: G.date[e], children: [
        ...
        /* @__PURE__ */ T.jsx(Ie, { header: G.city[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "town.name"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.place_given[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "date_of_place.name"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.titulature[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "titulature.full_name"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.commandement[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "commandement.full_name"
          }
        ) }),
        /* @__PURE__ */ T.jsx(Ie, { header: G.keywords[e], children: /* @__PURE__ */ T.jsx(
          We,
          {
            attribute: "keywords",
            operator: "or"
